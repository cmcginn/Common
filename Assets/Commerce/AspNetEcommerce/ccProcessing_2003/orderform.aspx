<%@ Page language="c#" AutoEventWireup="false" enableViewState="False" Codebehind="orderform.aspx.cs" validateRequest="False" inherits="PayPalIntegration.OrderForm" trace="true" %>
		...
		<form id="frmOrderForm" runat="server">
						...
						<p>
							<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="300">
								...
								<TR>
									...
									<TD>
										<asp:TextBox id="txtCC" runat="server" Width="360px"></asp:TextBox></TD>
								</TR>
								<TR>
            ...
            06</ASP:LISTITEM>
						...
						<P>Enter Order Amount:&nbsp;
							...
							<asp:button id="btnSubmit" runat="server" text="Go"></asp:button></P>
						<p>
